...
def GetCardPath(mass,year):
    ...
    cats["hww_lqq_bst_vbf_sb_"+year]="Datacard_M"+mass+"/__BoostedVBF_SB__nocut/Event/datacard.txt"
    cats["hww_lqq_bst_vbf_top_"+year]="Datacard_M"+mass+"/__BoostedVBF_TOP__nocut/Event/datacard.txt"
    cats["hww_lqq_bst_vbf_"+year]="Datacard_M"+mass+"/__BoostedVBF_SR__nocut/WW_mass/datacard.txt"
    
    #notcut
    cats["hww_lqq_res_vbf_sb_"+year]="Datacard_M"+mass+"/___ResolvedVBF__SB_notcut/Event/datacard.txt"
    cats["hww_lqq_res_vbf_top_"+year]="Datacard_M"+mass+"/___ResolvedVBF__TOP_notcut/Event/datacard.txt"
    cats["hww_lqq_res_vbf_"+year]="Datacard_M"+mass+"/___ResolvedVBF__SR_notcut/WW_mass/datacard.txt"
...
if __name__ == '__main__':
    ...
    workdir="WORKDIR/CombineCard/"+mass+"__"+bst+"__cut__"+year
