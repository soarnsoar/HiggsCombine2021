...
for YEAR in ${YEARS[@]};do
    ...
    text2workspace.py CombinedCard_${YEAR}.txt -P HiggsAnalysis.CombinedLimit.HiggsCombinePhysicsModel.HC_model_WJetsWTAG.WTAG_SF:WTAGSF -o WS_${YEAR}.root ${PO} &> WS.log&
