...
NP=1200
SF_bin0_RANGE=`python ../script/GetSigmaInScanBranch.py SF_bin0`
SF_bin1_RANGE=`python ../script/GetSigmaInScanBranch.py SF_bin1`
SF_bin2_RANGE=`python ../script/GetSigmaInScanBranch.py SF_bin2`
