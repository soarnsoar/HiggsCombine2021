	    ...
	    if options.pullDef and nuis_p!=None: 
		    ...
		    if options.pullDef and nuis_p!=None:
		      ...
		      gr_fit_b.SetPointError(nuis_p_i-1,0,0,abs(nuis_x.getErrorLo()),nuis_x.getErrorHi())
                      #print abs(nuis_x.getErrorLo()),nuis_x.getErrorHi()
                      if abs(nuis_x.getErrorLo())>1 or nuis_x.getErrorHi()>1:
                          dict_large_uncer[name]={'down':abs(nuis_x.getErrorLo()) , 'up':nuis_x.getErrorHi()}
