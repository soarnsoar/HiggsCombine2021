...
for MASS in ${ARR_MASS[@]};do
	...
	for YEAR in ${ARR_YEAR[@]};do
		...
		##--interference
		#python CondorSubmit_MakeWorkSpace.py -y ${YEAR} -m ${MASS} -b ${BST} -i -w ${WP}
		##--no interference
		#python CondorSubmit_MakeWorkSpace.py -y ${YEAR} -m ${MASS} -b ${BST} -w ${WP}
		python CondorSubmit_MakeWorkSpace.py -y ${YEAR} -m ${MASS} -b Boosted -w ${WP}
	    done
	done
    #done
done
...
for MASS in ${ARR_MASS[@]};do
	...
	for YEAR in ${ARR_YEAR[@]};do
		...
		##--no interference
		#python CondorSubmit_MakeWorkSpace.py -y ${YEAR} -m ${MASS} -b ${BST} -w ${WP}
		python CondorSubmit_MakeWorkSpace.py -y ${YEAR} -m ${MASS} -b Resolved -w ${WP}
	    done
	done
    #done
done
